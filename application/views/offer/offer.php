    ...
    <div id="offer-letter-container">
        <div id="offer-letter">
            ...
            <?php if($result->offer_logo):?>
                    <div align="right">
                <img src="<?= base_url($result->offer_logo);?>" alt="company logo" height="100" width="100">
                 </div>
            <?php endif;?>
            <!-- date -->
            ...
            <div style="margin-top: 20px;">
                <p>
                    We are pleased to offer you the  <b><?php 
                                            ...
                                            ?></b> <!--position of [job title]--> at <b><?php echo ucwords($result->teamname); ?></b> with a start date of <b><?php echo $result->joining_date; ?></b>, contingent upon [background check, I-9 form, etc.]. 
