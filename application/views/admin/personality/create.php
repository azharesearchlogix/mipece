            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right"><a href="<?php echo base_url('admin/personality'); ?>" class="btn btn-success btn-flat">Back</a></div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                <label>Personality 1 </label>
                                    <?php echo form_input(array('name' => 'name', 'type' => 'text', 'class' => 'form-control', 'required' => TRUE, 'placeholder' => 'Personality 1', 'value' => isset($result->personality1) ? set_value("name", $result->personality1) : set_value("name"))); ?>
