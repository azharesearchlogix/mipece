            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right"><a href="<?php echo base_url('admin/blog'); ?>" class="btn btn-success btn-flat">Back</a></div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td>Image</td>
                                <td><?php echo '<a href="' . base_url($result->image) . '" target="_blank"><img class="tbl-img" src="' . base_url($result->image) . '"></a>'; ?></td>
                            </tr>
