            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right"><a href="<?php echo base_url('admin/matchingsurvey'); ?>" class="btn btn-success btn-flat">Back</a></div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php
                                $select = (isset($result->industry_id)) ? $result->industry_id : $this->input->post('industry_id');
                                $industries = array('' => '---Select---');
                                foreach ($industry as $val) {
                                    $industries[$val->id] = $val->name;
                                }

                                echo form_dropdown('industry_id', $industries, $select, array('class' => 'form-control select2', 'required' => TRUE));
                                ?>
