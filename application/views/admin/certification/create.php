            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right"><a href="<?php echo base_url('admin/certification'); ?>" class="btn btn-success btn-flat">Back</a></div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                                <label>Role</label>
                                <?php
                                $selected = (isset($result->role_id)) ? $result->role_id : $this->input->post('role_id');
                                $role_ids = array('' => '---Select---');
                                foreach ($industries as $val) {
                                    $role_ids[$val->id] = $val->name;
                                }

                                echo form_dropdown('role_id', $role_ids, $selected, array('class' => 'form-control', 'required' => TRUE));
                                ?>
                            ...
                            <div class=" col-md-12">
                                <div class="form-group">
                                    <label>Name </label>
                                    <?php echo form_input(array('name' => 'title', 'type' => 'text', 'class' => 'form-control', 'required' => TRUE, 'placeholder' => 'Title', 'value' => isset($result->title) ? set_value("title", html_entity_decode($result->title)) : set_value("title"))); ?>
