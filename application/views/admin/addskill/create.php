                        ...
                        <div class="box-body">
                            ...
                            <div class=" col-md-6">
                                <div class="form-group">
                                    <label>Name </label>
                                    <?php echo form_input(array('name' => 'name', 'type' => 'text', 'class' => 'form-control', 'required' => TRUE, 'placeholder' => 'Name', 'value' => isset($result->skills) ? set_value("name", $result->skills) : set_value("name"))); ?>
