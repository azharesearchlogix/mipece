  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">UnRegistered Staffing Companies</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">UnRegistered Staffing Companies List</h3>
				...
				foreach($data as $post){
				 ...
				 <tr>
					...
					<td>
					 ...
					 <a href="<?php echo base_url().'admin/dashboard/userdelete/unregisteredUser/'.$post->id; ?>" class="btn btn-block1 btn-danger btn-sm delete_data" onClick="return confirm('Are you sure you want to delete?')" title="Delete"><i class="fa fa-trash"></i> Delete</a>
