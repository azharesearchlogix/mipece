            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right"><a href="<?php echo base_url('admin/factors'); ?>" class="btn btn-success btn-flat">Back</a></div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class=" col-md-6">
                                <div class="form-group">
                                    <label>Name </label>
                                    <?php echo form_input(array('name' => 'name', 'type' => 'text', 'class' => 'form-control', 'required' => TRUE, 'placeholder' => 'Name', 'value' => isset($result->name) ? set_value("name", html_entity_decode($result->name)) : set_value("name"))); ?>
