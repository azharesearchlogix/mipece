  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Registered Staffing Companies</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Registered Staffing Companies</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				foreach($data as $post){
				 ...
				 <tr>
				     ...
				     <a href="<?php echo base_url().'admin/dashboard/userdelete/registeredUser/'.$post->id; ?>" class="btn btn-block1 btn-danger btn-sm delete_data" onClick="return confirm('Are you sure you want to delete?')" title="Delete"><i class="fa fa-trash"></i> Delete</a>
