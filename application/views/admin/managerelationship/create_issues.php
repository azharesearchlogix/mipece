            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <?php
                        $action = (isset($result->id)) ? 'update_issues/' . $result->id.'/'.$id : 'create_issues/'.$id;
                        ...
                        <div class="box-body">
                            ...
                            <div class=" col-md-6">
                                <div class="form-group">
                                    <label>Relationship Issue </label>
                                    <?php echo form_input(array('name' => 'relationship', 'type' => 'text', 'class' => 'form-control', 'required' => TRUE, 'placeholder' => 'Relationship Title', 'value' => isset($result->relationship) ? set_value("relationship", $result->relationship) : set_value("relationship"))); ?>
                                    <span class="help-block"> <?php echo form_error('relationship'); ?> </span> 
                                </div>
                            </div>
