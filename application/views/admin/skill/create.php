                    ...
                    <div class="box-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php
                                $selected_ind = (isset($result->industry_id)) ? $result->industry_id : $this->input->post('industry_id');
                                $industries = array('' => '---Select---');
                                foreach ($industry as $val) {
                                    $industries[$val->id] = $val->name;
                                }
                                echo form_dropdown('industry_id', $industries, $selected_ind, array('class' => 'form-control', 'required' => TRUE));
                                ?>
